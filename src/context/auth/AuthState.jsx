...
export const loadUser = async (dispatch) => {
  try {
    const res = await axios.get('https://contact-keeper-server-v1.herokuapp.com/api/auth');
...
export const register = async (dispatch, formData) => {
  try {
    const res = await axios.post(
      'https://contact-keeper-server-v1.herokuapp.com/api/users',
      formData,
      config
    );
    dispatch({
...
export const login = async (dispatch, formData) => {
  try {
    const res = await axios.post(
      'https://contact-keeper-server-v1.herokuapp.com/api/auth',
      formData,
      config
    );
    dispatch({
